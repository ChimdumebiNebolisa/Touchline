...
- Added deterministic calibration proof that per-attempt negotiation reason-summary profiles remain stable across repeated Step 3 runs.
...
- Last successful pushed commit: 66cb0b6.