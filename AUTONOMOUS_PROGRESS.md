...
- Added deterministic calibration proof for equal-fee explainability artifact field ordering and label stability.

## Current subtask in progress
- Add bounded Step 3 calibration checks that preserve deterministic explainability artifact summaries across repeated regression runs.
