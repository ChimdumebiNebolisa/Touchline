...
- Added deterministic calibration proof that explainability summary delimiters remain stable across repeated runs.

## Current subtask in progress
- Add bounded Step 3 calibration checks that preserve deterministic explainability-summary segment counts in regression snapshots.
