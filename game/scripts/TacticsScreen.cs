...
public partial class TacticsScreen : Control
{
    ...
    private void CacheNodes()
    {
        ...
        _pitchCard = GetNode<PanelContainer>("RootMargin/Shell/MainColumn/MainScroll/ScrollContent/ContentRow/PitchCard");
        _formationBadgeLabel = GetNode<Label>("RootMargin/Shell/MainColumn/MainScroll/ScrollContent/ContentRow/PitchCard/PitchPadding/PitchContent/TopMeta/FormationBadgeLabel");
        _pitchSummaryLabel = GetNode<Label>("RootMargin/Shell/MainColumn/MainScroll/ScrollContent/ContentRow/PitchCard/PitchPadding/PitchContent/TopMeta/PitchSummaryLabel");
        _pitchPanel = GetNode<PanelContainer>("RootMargin/Shell/MainColumn/MainScroll/ScrollContent/ContentRow/PitchCard/PitchPadding/PitchContent/PitchPanel");
        _pitchField = GetNode<Control>("RootMargin/Shell/MainColumn/MainScroll/ScrollContent/ContentRow/PitchCard/PitchPadding/PitchContent/PitchPanel/PitchPanelPadding/PitchField");
        _pitchRows = GetNode<Control>("RootMargin/Shell/MainColumn/MainScroll/ScrollContent/ContentRow/PitchCard/PitchPadding/PitchContent/PitchPanel/PitchPanelPadding/PitchField/PitchRows");
        _frontRowLabel = GetNode<Label>("RootMargin/Shell/MainColumn/MainScroll/ScrollContent/ContentRow/PitchCard/PitchPadding/PitchContent/PitchPanel/PitchPanelPadding/PitchField/PitchRows/FrontRow/FrontRowLabel");
        _attackBandLabel = GetNode<Label>("RootMargin/Shell/MainColumn/MainScroll/ScrollContent/ContentRow/PitchCard/PitchPadding/PitchContent/PitchPanel/PitchPanelPadding/PitchField/PitchRows/AttackBand/AttackBandLabel");
        _midfieldBandLabel = GetNode<Label>("RootMargin/Shell/MainColumn/MainScroll/ScrollContent/ContentRow/PitchCard/PitchPadding/PitchContent/PitchPanel/PitchPanelPadding/PitchField/PitchRows/MidfieldBand/MidfieldBandLabel");
        _backLineLabel = GetNode<Label>("RootMargin/Shell/MainColumn/MainScroll/ScrollContent/ContentRow/PitchCard/PitchPadding/PitchContent/PitchPanel/PitchPanelPadding/PitchField/PitchRows/BackLine/BackLineLabel");
        _keeperLabel = GetNode<Label>("RootMargin/Shell/MainColumn/MainScroll/ScrollContent/ContentRow/PitchCard/PitchPadding/PitchContent/PitchPanel/PitchPanelPadding/PitchField/PitchRows/KeeperRow/KeeperLabel");
        _leftChannelLabel = GetNode<Label>("RootMargin/Shell/MainColumn/MainScroll/ScrollContent/ContentRow/PitchCard/PitchPadding/PitchContent/ChannelRow/LeftChannel");
        _centerChannelLabel = GetNode<Label>("RootMargin/Shell/MainColumn/MainScroll/ScrollContent/ContentRow/PitchCard/PitchPadding/PitchContent/ChannelRow/CenterChannel");
        _rightChannelLabel = GetNode<Label>("RootMargin/Shell/MainColumn/MainScroll/ScrollContent/ContentRow/PitchCard/PitchPadding/PitchContent/ChannelRow/RightChannel");
        _shapeSummaryLabel = GetNode<Label>("RootMargin/Shell/MainColumn/MainScroll/ScrollContent/ContentRow/PitchCard/PitchPadding/PitchContent/ShapeSummaryLabel");
        _previewSummaryLabel = GetNode<Label>("RootMargin/Shell/MainColumn/MainScroll/ScrollContent/ContentRow/PitchCard/PitchPadding/PitchContent/PreviewSummaryLabel");
        _statusLabel = GetNode<Label>("RootMargin/Shell/MainColumn/MainScroll/ScrollContent/ContentRow/PitchCard/PitchPadding/PitchContent/StatusLabel");
        _controlsCard = GetNode<PanelContainer>("RootMargin/Shell/MainColumn/MainScroll/ScrollContent/ContentRow/SideStack/ControlsCard");
        _controlHintLabel = GetNode<Label>("RootMargin/Shell/MainColumn/MainScroll/ScrollContent/ContentRow/SideStack/ControlsCard/ControlsPadding/ControlsContent/ControlsHintLabel");
        _formationOption = GetNode<OptionButton>("RootMargin/Shell/MainColumn/MainScroll/ScrollContent/ContentRow/SideStack/ControlsCard/ControlsPadding/ControlsContent/FormationOption");
        EnsureTeamStyleOption();
        _pressSpin = GetNode<SpinBox>("RootMargin/Shell/MainColumn/MainScroll/ScrollContent/ContentRow/SideStack/ControlsCard/ControlsPadding/ControlsContent/PressSpin");
        _tempoSpin = GetNode<SpinBox>("RootMargin/Shell/MainColumn/MainScroll/ScrollContent/ContentRow/SideStack/ControlsCard/ControlsPadding/ControlsContent/TempoSpin");
        _widthSpin = GetNode<SpinBox>("RootMargin/Shell/MainColumn/MainScroll/ScrollContent/ContentRow/SideStack/ControlsCard/ControlsPadding/ControlsContent/WidthSpin");
        _riskSpin = GetNode<SpinBox>("RootMargin/Shell/MainColumn/MainScroll/ScrollContent/ContentRow/SideStack/ControlsCard/ControlsPadding/ControlsContent/RiskSpin");
        _controlSummaryLabel = GetNode<Label>("RootMargin/Shell/MainColumn/MainScroll/ScrollContent/ContentRow/SideStack/ControlsCard/ControlsPadding/ControlsContent/ControlSummaryLabel");
        _notesCard = GetNode<PanelContainer>("RootMargin/Shell/MainColumn/MainScroll/ScrollContent/ContentRow/SideStack/NotesCard");
        _pressPreviewLabel = GetNode<Label>("RootMargin/Shell/MainColumn/MainScroll/ScrollContent/ContentRow/SideStack/NotesCard/NotesPadding/NotesContent/PressPreviewLabel");
        _tempoPreviewLabel = GetNode<Label>("RootMargin/Shell/MainColumn/MainScroll/ScrollContent/ContentRow/SideStack/NotesCard/NotesPadding/NotesContent/TempoPreviewLabel");
        _widthPreviewLabel = GetNode<Label>("RootMargin/Shell/MainColumn/MainScroll/ScrollContent/ContentRow/SideStack/NotesCard/NotesPadding/NotesContent/WidthPreviewLabel");
        _riskPreviewLabel = GetNode<Label>("RootMargin/Shell/MainColumn/MainScroll/ScrollContent/ContentRow/SideStack/NotesCard/NotesPadding/NotesContent/RiskPreviewLabel");
        _savedPlanLabel = GetNode<Label>("RootMargin/Shell/MainColumn/MainScroll/ScrollContent/ContentRow/SideStack/NotesCard/NotesPadding/NotesContent/SavedPlanLabel");
    }
